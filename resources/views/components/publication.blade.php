<div class="card my-2 bg-light">
    <div class="card-body">
       ...
       <blockquote class="blockquote mb-0">
        ...
        <a class="btn btn-primary  btn-sm float-end" href="{{route('publications.edit',$publication->id)}}">Modifier</a>
        @endcan
         ...
         <form action="{{route('publications.destroy',$publication->id)}}" method="post">
            @csrf
            @method('DELETE')
            <button onclick="return confirm('voulez vous vraiment supprimer cette publication ?')" class="  mx-2 btn btn-danger  btn-sm float-end " >Supprimer</button>
         </form>
